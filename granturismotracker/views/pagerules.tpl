...
<div class="flex-column m-s">
    ...
    <div class="flex-1 flex-hc frusso fs-m fg-blue-light mt-s">Driving</div>
    ...
    <div class="mv-s"/>
    <div class="flex-1 flex-hc frusso fs-m fg-blue-light mt-s">Scoring</div>
    ...
    <div class="flex-1 mv-xs foswald fs-s fg-blue-light">First, the fastest driver on any combination of track and car is awarded 100 points for current performance, and the slower drivers are awarded proportionally less points. For example, if the fastest driver set a lap time of 1:00.000, then that driver would be awarded 100 points, whereas drivers with a lap time of 2:00.000 would be awarded only 50 points, as 2:00.000 is only half as fast as 1:00.000.</div>

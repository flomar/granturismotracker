...
<div class="flex-column m-s">
    ...
    <div class="flex-1 mv-xs foswald fs-s fg-blue-light">Once a car has been introduced into the car pool, tuning parts must not be added or removed.</div>
    <div class="flex-1 mv-xs foswald fs-s fg-blue-light">For street cars, tires are set to Sports Soft (SS), and for race cars, tires are set to Racing Soft (RS).</div>
    <div class="flex-1 mv-xs foswald fs-s fg-blue-light">All other tuning options can be changed at the discretion of the driver.</div>
    ...
    <div class="flex-1 mv-xs foswald fs-s fg-blue-light">It is important to note that the points for current performance are fully dynamic in that they can be taken away by other drivers, but the points for past performance are not.</div>
</div>
